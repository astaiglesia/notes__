...
tl;dr:  // [] one paragraph max... 1 sentence overview, 1 sentence alcove retail, i sentence greenhouse restaurant/cafe, 1 sentence modularity + special uses
mixed-use retail redevelopment featuring 



[] 5 year milestones outlook (retail business plan synopsis) 2-3 sentences; note modularity and  program iteration and community responsiveness as we transition to a full fledged restaurant when the neighorhood has spoken... perhaps a full length market is more necessary for the neighorhood




> *residential description*
 the residential build targets the burgeoning middle income market who love the area, want the luxury without the highrise feel or need for a complex of amenities. cool, modern, minimal with polished concrete, wood, steel, large/ full height glazing. pricepoint is slightly above the neighborhood but the developmental trajectory of the neighborhood that we would like to drive is incorporated into the vision
